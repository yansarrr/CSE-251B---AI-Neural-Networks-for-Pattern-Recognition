...
def params():
    ...
    # add decay rate for LLRD
    parser.add_argument("--decay-rate", default=0.9, type=float,
            help="Decay rate for Layer-wise Learning Rate Decay (LLRD).")

    # add warmup percentage
    parser.add_argument("--warmup-steps", default=0.1, type=float,
                help="Fraction of total steps to use for learning rate warm-up.")

    # llrd flag
    parser.add_argument("--use-llrd", action="store_true",
                help="Enable Layer-wise Learning Rate Decay (LLRD).")

    # warmup flag
    parser.add_argument("--use-warmup", action="store_true",
                    help="Enable Learning Rate Warm-up.")
